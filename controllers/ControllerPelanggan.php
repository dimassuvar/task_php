<?php 
    ...
    switch ($tombol) {
        ...
        header('Location:http://localhost/LatihanPHP_3/praktikum-praktikum/crud/CreatePelanggan.php');
            break;
    }

    // Landing Page
    header('Location:http://localhost/LatihanPHP_3/praktikum-praktikum/crud/pelanggan.php');
?>