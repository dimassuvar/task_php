<?php 
    ...
    switch ($tombol) {
        ...
        header('Location:http://localhost/LatihanPHP_3/praktikum-praktikum/crud/CreateProduk.php');
            break;
    }

    // Landing Page
    header('Location:http://localhost/LatihanPHP_3/praktikum-praktikum/crud/produk.php');
?>